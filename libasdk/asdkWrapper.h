 ...
 *
 * @param[in] pDm   Pointer to DM object.
 * @param[in] value Array of value to send to the DM.
 *      For DM, value must be nAct long and contains the value in [-1:1] for
 *      each actuator. nMode can be obtained with asdkGet(pDm, "NbOfActuator")
 *      For DMM, value must be nMode long and contains values in meter PV for
 *      nMode Zernike modes (Noll). nMode can be obtained with asdkGet(pDm, "NbOfMode")
 *
 * @return On success, SUCCESS is returned. Otherwise, FAILURE is
 * returned and asdkGetLastError() can be used to get error description.
 */
...
/**
* Get value of one vector parameter
*
* @param[in]  pDm      Pointer to DM object.
* @param[in]  command  Parameter name
* @param[out] value    Returned value as pointer to an array of Scalar.
*  You are responsible for deallocating this after use with asdkFreeVector
* @param[out] nbElements number of array elements.
*
* @return On success, SUCCESS is returned. Otherwise, FAILURE is
* returned and asdkGetLastError() can be used to get an error description.
*/
ASDK_API COMPL_STAT asdkGetVector(asdkDM *pDm, CStrConst command, Scalar ** value, uint32_t* nbElements);


/**
 * Free memory for the vector in parameter.
 * @param[in,out] value Pointer to a Scalar array.
 */
ASDK_API COMPL_STAT asdkFreeVector(Scalar ** value);
...
* @param[in]  pDm      Pointer to DM object.
* @param[in]  command  Parameter name
* @param[out] str    Returned value as pointer to a string (array of char terminated by 0).
*  You are responsible for deallocating this after use with asdkFreeString
*
* @return On success, SUCCESS is returned. Otherwise, FAILURE is
* returned and asdkGetLastError() can be used to get an error description.
*/
ASDK_API COMPL_STAT asdkGetString(asdkDM *pDm, CStrConst command, char ** str);

/**
 * Free memory for the string in parameter.
 * @param[in,out] value Pointer to a char array.
 */
ASDK_API COMPL_STAT asdkFreeString(char ** value);
...
* @param[in] pDm      Pointer to DM object.
* @param[in] command  Parameter name.
* @param[in] vector   New value.
* @param[in] size of the vector
*
* @return On success, acecsSUCCESS is returned. Otherwise, FAILURE is
* returned and asdkGetLastError() can be used to get an error description.
*/
ASDK_API COMPL_STAT asdkSetVector( asdkDM *pDm, CStrConst command, const Scalar* vector, Int size);
